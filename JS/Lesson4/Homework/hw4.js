...
//     i++;
// };
// console.log(`На ${i} день продаж количество доступных к покупке авто станет меньше ${M}`);
...
// }
// }
// console.log(`Год первого полета человека в космос ${yearOfFly},колчество итераций которое потребовалось для поиска ${count}`);

// console.log(`Количество високосных годов с 1800 по 2020 год равно ${c}`);
